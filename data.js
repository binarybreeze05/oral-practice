...
window.RECORDINGS = [
  ...
  },
  {
    ...
    "title": "Translate-FR-Test",
    "date": "2026-06-21",
    "source": "s2t",
    "french": [
      "Bon. Euh, alors c'est juste moi qui teste le nouvel outil de speech-to-text pour, euh, pour ElevenLabs. Euh, donc ouais, je suis en t- je suis juste, euh, en train de tester cet outil. Euh, je vais lire cette pub, et après je vais p- poser deux-trois questions par rapport à ça. Euh, donc ouais, voyons voir, euh, voyons voir comment il s'en sort."
    ],
    "english": [
      "All right. Um, so this is just me testing the new speech-to-text tool for, um, for ElevenLabs. Um, so yeah, I'm j- I'm just, uh, trying to test this tool. Um, gonna read this ad, and then I'm gonna a- ask a couple questions related to this. Um, so yeah, let's see, uh, let's see how it does."
    ],
    "audio": "audio/Translate-FR-Test.mp3"
  }
];
